...
class DVR_Admin {
	...
	public static function lam_sach( $v ) {
		...
		foreach ( array( 'shop_name', 'bank_id', 'bank_account', 'bank_name', 'bank_label', 'amadeus_id', 'amadeus_secret', 'webhook_secret', 'tax_api',
			'aff_traveloka', 'aff_trip', 'aff_kiwi', 'duffel_token', 'dl_ten', 'dl_url', 'dl_token', 'dl_header', 'dl_body', 'dl_map', 'hero_ten', 'hero_tieu_de', 'hero_phu_de', 'cty_vi', 'cty_en', 'cty_mst', 'cty_dai_dien', 'cty_tu_ngay', 'cty_dia_chi', 'cty_dien_thoai', 'cty_co_quan', 'cty_chi_nhanh' ) as $k ) {
		...
		$cd                = isset( $v['che_do'] ) ? $v['che_do'] : 'ban';
		$ra['che_do']      = in_array( $cd, array( 'ban', 'gioi_thieu' ), true ) ? $cd : 'ban';
