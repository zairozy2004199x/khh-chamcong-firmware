...
require_once VHG_DIR . 'includes/class-vhg-vemini.php';
...
/* API bán vé trước cho Zalo Mini App (REST vhg/v1/ve/*). Tự tạo bảng bc_ve khi cần. */
add_action( 'init', array( 'VHG_Vemini', 'init' ), 6 );
