...
| Bản plugin | **3.50.0** (đi từ 3.41.0 trong đợt này) |
| Bản cài | `dist/vhcp-cham-cong.zip` — đã đóng gói đúng 3.50.0 |
| Live | anh Thắng đã cài và xác nhận chạy |
| Bộ thử | **4853 phép** đạt (`test-cham-cong.php`), 8 bộ khác xanh |
...
## 5. Bảy cái bẫy đã trả giá — đừng lặp
...
```bash
php tools/test/test-cham-cong.php        # 4853 phép — bộ chính
