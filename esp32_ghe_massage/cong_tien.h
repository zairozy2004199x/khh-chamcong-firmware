 ...
 *      Dây B (ghế->ICT: 3E/5E/02) KHÔNG đụng tới — tap vào nó làm RỚT ICT (nó là
 *      dây sống chở lệnh mở khoá), nên bỏ, không đọc 02.
 *
...
typedef void (*TienMatCb)(long vnd);              // có tờ tiền mặt thật (đã nuốt)
typedef void (*LoiTienCb)(const char* ma, bool active);   // báo lỗi (khớp wrapper ghiLoiTien)
