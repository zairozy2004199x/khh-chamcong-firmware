...
/* ───────────────────────────────────────────────────────────────────────────────────────────
 * TỰ CẬP NHẬT TỪ GITHUB (3.87.0).
 *
 * Anh Thắng 15/09/2026: *"Việt vào plugin để cập nhật cũng bất tiện"* — và từ điện thoại thì
 * wp-admin còn không mở nổi. Gắn lớp này là plugin chấm công: (a) hiện nút Cập nhật ở màn
 * Plugin của WordPress, (b) TỰ hiện thêm một dòng ở trang tổng khmatrix.com/it — trang ấy dựng
 * bảng từ bộ lọc `vhcp_tu_cap_nhat_ds` nên không phải sửa bên đó dòng nào.
 *
 * Nạp ở đây — SAU mọi lớp nghiệp vụ, TRƯỚC móc kích hoạt — vì nó không phụ thuộc lớp nào; chỉ
 * cần hằng VHCC_VERSION đã khai bên trên.
 * ─────────────────────────────────────────────────────────────────────────────────────────── */
require_once VHCC_DIR . 'tu-cap-nhat.php';
VHCC_TuCapNhat::init();
