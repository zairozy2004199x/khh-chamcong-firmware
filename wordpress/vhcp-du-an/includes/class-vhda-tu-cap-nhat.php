...
class VHDA_TuCapNhat {
	...
	private static function ban_hien() {
		return defined( 'VHDA_VERSION' ) ? (string) VHDA_VERSION : '0';
	}
	...
	private static function duong() {
		return plugin_basename( VHDA_DIR . 'vhcp-du-an.php' );
	}
	...
	public static function ban_moi( $bo_qua_nho = false ) {
		...
		$hien  = defined( 'VHDA_VERSION' ) ? VHDA_VERSION : '0';
		$tot   = null;
		foreach ( $ds as $rel ) {
