 ...
 *        · ĐẾM, CẢNH BÁO và TẢI LÊN ảnh (`class-vhjp-anh.php`)
 *        · KẾ TOÁN duyệt / trả về (`class-vhjp-duyet.php`).
 * Chưa:  74 / 100 hàm máy chủ — `VHJP_Cong::chua_lam()` khai đủ tên, và
 *        `tools/test/kiem-jp-cong.php` đếm lại mỗi lượt chạy. Nặng nhất còn lại: KHO HAI TẦNG (sổ 632)
 *        · đối soát ngân hàng · nộp tiền.
 *
 * 🔴 ẢNH CẤT TRÊN HOST, KHÔNG CÒN Ở DRIVE (từ 22/09/2026). Ảnh MỚI vào thư mục tải lên của
 *    WordPress dưới tên ngẫu nhiên 32 ký tự; ảnh CŨ trên Drive vẫn xem được, không phải chuyển.
 *    Cửa ghi tệp ấy SOI BỐN BYTE ĐẦU chứ không tin cái nhãn `data:image/...` do máy khách viết
 *    ra — lấy đuôi tệp từ nhãn là có `.php` nằm trong uploads, và mở bằng trình duyệt là CHẠY.
 *
...
require_once VHJP_DIR . 'includes/class-vhjp-kho.php';
require_once VHJP_DIR . 'includes/class-vhjp-so.php';
require_once VHJP_DIR . 'includes/class-vhjp-but-toan.php';
require_once VHJP_DIR . 'includes/class-vhjp-nop-tien.php';
require_once VHJP_DIR . 'includes/class-vhjp-bang.php';
require_once VHJP_DIR . 'includes/class-vhjp-cau-hinh-2.php';
require_once VHJP_DIR . 'includes/class-vhjp-doi-soat.php';
require_once VHJP_DIR . 'includes/class-vhjp-quet.php';
