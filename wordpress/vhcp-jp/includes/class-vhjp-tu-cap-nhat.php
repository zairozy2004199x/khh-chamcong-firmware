...
class VHJP_TuCapNhat {
	...
	private static function ban_hien() {
		return defined( 'VHJP_VERSION' ) ? (string) VHJP_VERSION : '0';
	}
	...
	private static function duong() {
		return plugin_basename( VHJP_DIR . 'vhcp-jp.php' );
	}
	...
	public static function ban_moi( $bo_qua_nho = false ) {
		...
		$hien  = defined( 'VHJP_VERSION' ) ? VHJP_VERSION : '0';
		$tot   = null;
		foreach ( $ds as $rel ) {
