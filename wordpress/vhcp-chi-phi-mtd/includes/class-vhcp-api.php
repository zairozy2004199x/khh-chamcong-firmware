...
class VHCPMTD_API {
	...
	public static function map() {
		return array(
			...
			'xuatGoiCauHinh'        => array( 'VHCPMTD_Cfg', 'xuat_goi_cau_hinh' ),
			'nhapGoiCauHinh'        => array( 'VHCPMTD_Cfg', 'nhap_goi_cau_hinh' ),
			...
			/* Admin dọn lệnh đã bị trả — xem `VHCPMTD_DuAn::xoa_dot_tra()`, chốt Admin nằm trong hàm. */
			'xoaLenhTraDuAn'        => array( 'VHCPMTD_DuAn', 'xoa_dot_tra' ),
