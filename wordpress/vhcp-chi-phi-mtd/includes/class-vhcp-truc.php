...
class VHCPMTD_Truc {
	 ...
	 *
	 * Mỗi mục:
	 *   cot      cột trong bảng `chiphi`. Thêm trục = thêm cột + nâng `VHCPMTD_DB::SCHEMA_VERSION`.
	 ...
	 *
	 * 🔴 KHÔNG CHÉP LẠI CHUỖI GIÁ TRỊ Ở ĐÂY. Hai hằng `GIAI_DOAN_*` đã sống ở `VHCPMTD_Don` và cả
	...
	public static function ds() {
		$ds = array(
			'giaiDoan' => array(
				...
				'nhan'    => 'Giai đoạn',
				'kieu'    => 'tich',
				'gtri'    => VHCPMTD_Don::GIAI_DOAN_DS,
				'macDinh' => VHCPMTD_Don::GIAI_DOAN_VH,
				'bat'     => VHCPMTD_Don::GIAI_DOAN_SETUP,
		 ...
		 */
		return apply_filters( 'vhcpmtd_truc_ds', $ds );
	}
