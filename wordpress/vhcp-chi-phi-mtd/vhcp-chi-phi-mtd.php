 ...
 */
define( 'VHCPMTD_VERSION', '1.339.0' );
...
add_action( 'wp_ajax_nopriv_vhcpmtd_vending_nhan', array( 'VHCPMTD_Vending', 'ajax_nhan' ) );
add_action( 'wp_ajax_vhcpmtd_vending_nhan', array( 'VHCPMTD_Vending', 'ajax_nhan' ) );
