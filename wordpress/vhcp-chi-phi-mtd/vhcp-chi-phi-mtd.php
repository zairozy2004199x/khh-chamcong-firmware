<?php
/**
 * Plugin Name:       Chi Phí — Máy Tự Động (MTD)
 ...
 */
define( 'VHCPMTD_VERSION', '1.163.0' );
...
function vhcpmtd_maybe_upgrade() {
	...
	if ( get_option( 'vhcpmtd_hut_coso_ghe' ) !== VHCPMTD_VERSION ) {
		update_option( 'vhcpmtd_hut_coso_ghe', VHCPMTD_VERSION );
