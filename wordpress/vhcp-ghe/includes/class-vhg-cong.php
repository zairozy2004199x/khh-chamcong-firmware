...
class VHG_Cong {
	...
	private static function cong_may() {
		...
		VHG_May::nhip( $ma_may, array(
			...
			'tm_loi'     => isset( $d['tm_loi'] ) ? $d['tm_loi'] : '',
			'tm_cuoi'    => isset( $d['tm_cuoi'] ) ? $d['tm_cuoi'] : '',
			'tm_lan'     => isset( $d['tm_lan'] ) ? $d['tm_lan'] : 0,
			'tm_giay'    => isset( $d['tm_giay'] ) ? $d['tm_giay'] : -1,
			'tm_to'      => isset( $d['tm_to'] ) ? $d['tm_to'] : -1,
			'ip'         => isset( $d['ip'] ) ? $d['ip'] : '',
			'fw'         => isset( $d['fw'] ) ? $d['fw'] : '',
			'nd'         => isset( $d['nd'] ) ? $d['nd'] : '',
		) );
