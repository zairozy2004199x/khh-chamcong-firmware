...
class VHCPHN_API {
	...
	public static function map() {
		return array(
			...
			'xuatGoiCauHinh'        => array( 'VHCPHN_Cfg', 'xuat_goi_cau_hinh' ),
			'nhapGoiCauHinh'        => array( 'VHCPHN_Cfg', 'nhap_goi_cau_hinh' ),
			...
			'doiLuongDon'           => array( 'VHCPHN_Don', 'doi_luong_don' ),
			...
			'doanhThuChiPhi'        => array( 'VHCPHN_DoanhThu', 'so_sanh' ),
			'kiemTraDoanhThu'       => array( 'VHCPHN_DoanhThu', 'kiem_tra' ),
			'dongBoVending'         => array( 'VHCPHN_Vending', 'dong_bo' ),
			'kiemTraVending'        => array( 'VHCPHN_Vending', 'kiem_tra' ),
			...
			'danhDauThanhToanNhieu' => array( 'VHCPHN_Don', 'danh_dau_thanh_toan_nhieu' ),
