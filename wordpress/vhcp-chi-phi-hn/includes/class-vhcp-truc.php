...
class VHCPHN_Truc {
	 ...
	 *
	 * Mỗi mục:
	 *   cot      cột trong bảng `chiphi`. Thêm trục = thêm cột + nâng `VHCPHN_DB::SCHEMA_VERSION`.
	 ...
	 *
	 * 🔴 KHÔNG CHÉP LẠI CHUỖI GIÁ TRỊ Ở ĐÂY. Hai hằng `GIAI_DOAN_*` đã sống ở `VHCPHN_Don` và cả
	...
	public static function ds() {
		$ds = array(
			'giaiDoan' => array(
				...
				'nhan'    => 'Giai đoạn',
				'kieu'    => 'tich',
				'gtri'    => VHCPHN_Don::GIAI_DOAN_DS,
				'macDinh' => VHCPHN_Don::GIAI_DOAN_VH,
				'bat'     => VHCPHN_Don::GIAI_DOAN_SETUP,
		 ...
		 */
		return apply_filters( 'vhcphn_truc_ds', $ds );
	}
