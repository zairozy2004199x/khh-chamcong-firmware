...
class VHCPVP_Truc {
	 ...
	 *
	 * Mỗi mục:
	 *   cot      cột trong bảng `chiphi`. Thêm trục = thêm cột + nâng `VHCPVP_DB::SCHEMA_VERSION`.
	 ...
	 *
	 * 🔴 KHÔNG CHÉP LẠI CHUỖI GIÁ TRỊ Ở ĐÂY. Hai hằng `GIAI_DOAN_*` đã sống ở `VHCPVP_Don` và cả
	...
	public static function ds() {
		$ds = array(
			'giaiDoan' => array(
				...
				'nhan'    => 'Giai đoạn',
				'kieu'    => 'tich',
				'gtri'    => VHCPVP_Don::GIAI_DOAN_DS,
				'macDinh' => VHCPVP_Don::GIAI_DOAN_VH,
				'bat'     => VHCPVP_Don::GIAI_DOAN_SETUP,
		 ...
		 */
		return apply_filters( 'vhcpvp_truc_ds', $ds );
	}
