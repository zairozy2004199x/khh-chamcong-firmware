...
class VHCPVP_Misa {
	...
	/** Khoảng ngày của kỳ dài ĐÚNG 7 ngày — cách tuần chuẩn được sinh ra (`VHCPVP_Don::nhan_ky`). */
	...
	public static function export_misa( $ky = 'all', $mode = 'chuaxuat', $pl_f = 'all', $mau = self::MAU_CHUAN, $tk_f = 'all' ) {
		...
		foreach ( $cp as $r ) {
			...
			/* TK Có = BÊN TRẢ TIỀN. Ba bậc, và bậc đầu là mới (anh Thắng 21/09/2026: *"MTĐ tùy
			   ...
			   Bậc 1 bỏ trống thì hai bậc sau y như cũ — xem chốt dài ở `VHCPVP_Cfg::tkco_xuat()`.
	...
	public static function mark_exported( $ma_dons, $pl_f = 'all' ) {
		...
		return VHCPVP_Util::ok( array( 'count' => $n ) );
	}
}
