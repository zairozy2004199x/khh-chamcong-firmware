...
class VHNB_TuCapNhat {
	...
	private static function ban_hien() {
		return defined( 'VHNB_VERSION' ) ? (string) VHNB_VERSION : '0';
	}
	...
	private static function duong() {
		return plugin_basename( VHNB_DIR . 'vhcp-noi-bo.php' );
	}
	...
	public static function ban_moi( $bo_qua_nho = false ) {
		...
		$hien  = defined( 'VHNB_VERSION' ) ? VHNB_VERSION : '0';
		$tot   = null;
		foreach ( $ds as $rel ) {
