...
class VHCPT_Api {
	 ...
	 */
	private static function chot_ghi( $args ) {
		...
		if ( ! in_array( $khoa, VHCPT_Auth::ban_duyet_duoc(), true ) ) {
			return array( 'error' => 'Bạn không có quyền duyệt ở mảng ' . VHCPT_Ban::ten( $khoa ) . '.' );
		}
