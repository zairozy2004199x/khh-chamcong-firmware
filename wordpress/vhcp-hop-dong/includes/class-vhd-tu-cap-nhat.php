...
class VHD_TuCapNhat {
	...
	private static function ban_hien() {
		return defined( 'VHD_VERSION' ) ? (string) VHD_VERSION : '0';
	}
	...
	private static function duong() {
		return plugin_basename( VHD_DIR . 'vhcp-hop-dong.php' );
	}
	...
	public static function ban_moi( $bo_qua_nho = false ) {
		...
		$hien  = defined( 'VHD_VERSION' ) ? VHD_VERSION : '0';
		$tot   = null;
		foreach ( $ds as $rel ) {
