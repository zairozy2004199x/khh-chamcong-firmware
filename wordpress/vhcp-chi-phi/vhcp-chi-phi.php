...
require_once VHCP_DIR . 'includes/class-vhcp-hopdong.php';
...
require_once VHCP_DIR . 'includes/class-vhcp-hdapp.php';
...
// Thư viện hợp đồng: hệ thống riêng, đường dẫn riêng (/hop-dong/)
add_action( 'init', array( 'VHCP_HDApp', 'init' ), 5 );
...
add_shortcode( 'vhcp_hopdong', array( 'VHCP_HDApp', 'shortcode' ) );
