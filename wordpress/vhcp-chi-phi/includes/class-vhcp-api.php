...
class VHCP_API {
	...
	public static function map() {
		return array(
			...
			'doiCoSoDon'            => array( 'VHCP_Don', 'doi_coso_don' ),
			...
			'doiLuongDon'           => array( 'VHCP_Don', 'doi_luong_don' ),
			...
			'suaTamUngDaCap'        => array( 'VHCP_Don', 'sua_tam_ung_da_cap' ),
			/* Admin trả ngược "Đã cấp" → "Chờ cấp tạm ứng" để làm lại đơn sai. */
			'goCapTamUng'           => array( 'VHCP_Don', 'go_cap_tam_ung' ),
			...
			'doanhThuChiPhi'        => array( 'VHCP_DoanhThu', 'so_sanh' ),
			'kiemTraDoanhThu'       => array( 'VHCP_DoanhThu', 'kiem_tra' ),
			'dongBoVending'         => array( 'VHCP_Vending', 'dong_bo' ),
			'kiemTraVending'        => array( 'VHCP_Vending', 'kiem_tra' ),
