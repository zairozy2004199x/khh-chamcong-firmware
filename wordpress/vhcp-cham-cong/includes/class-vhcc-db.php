 ...
 *
 * Không có bảng hợp đồng: dữ liệu chấm công ở Google Sheet, plugin không giữ bản sao nào.
 * Giữ bản sao là sinh ra hai nguồn sự thật, rồi sớm muộn lệch nhau mà không ai biết bên nào đúng.
 *
 * Bảng NGƯỜI DÙNG thì dùng chung với plugin Vận hành chi phí (xem class-vhcc-auth.php) để nhân sự
