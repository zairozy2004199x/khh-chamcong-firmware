 ...
 *
 * ⚠️ TỆP NÀY LÀ BẢN SAO, sinh từ `wordpress/vhcp-chi-phi/includes/class-vhcp-tu-cap-nhat.php`.
...
class VHTC_TuCapNhat {
	...
	const TIEN_TO = 'vhcp-trang-chu-v';
	...
	private static function ban_hien() {
		return defined( 'VHTC_VERSION' ) ? (string) VHTC_VERSION : '0';
	}
	...
	private static function duong() {
		return plugin_basename( VHTC_DIR . 'vhcp-trang-chu.php' );
	}
	...
	public static function ban_moi( $bo_qua_nho = false ) {
		...
		$hien  = defined( 'VHTC_VERSION' ) ? VHTC_VERSION : '0';
		$tot   = null;
		foreach ( $ds as $rel ) {
