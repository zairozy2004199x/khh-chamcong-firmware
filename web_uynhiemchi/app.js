  ...
  function moJSON(file) {
    ...
    fr.onload = (ev) => {
      try {
        ...
        S.nhatKy = g.nhatKy || [];
        [[KHOA.recs, S.recs], [KHOA.theoDoi, S.theoDoi], [KHOA.congTy, S.congTy], [KHOA.tuyChon, S.tuyChon], [KHOA.nhatKy, S.nhatKy]]
          .forEach(([k, v]) => luu(k, v));
        S.chon.clear();
        S.loc = {};
        $('fKy').dataset.dung = '';
