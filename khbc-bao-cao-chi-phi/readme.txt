...
= 1.31.0 =
* **Nút 🗑 Xoá dòng trống** trên Mục III (anh Thắng: *"nó nhân ra hàng thừa, giờ sao xoá đi"*).
  Nút chỉ hiện khi thật sự có dòng trống, nói rõ bao nhiêu dòng, và có **Hoàn tác**.
* 🔴 Chỉ xoá dòng **không tên · không số · không nối nguồn · không mã đơn vị · không nội dung
  MISA**. Dòng **có tên mà chưa có số vẫn giữ** — đó là cơ sở đang chờ số của kỳ này; xoá nó là
  xoá mất một cơ sở khỏi báo cáo.
* Chặn từ gốc: đường tự tạo không còn sinh dòng không tên.
...
* 🔴 **Sửa lỗi 1.26.0 không dọn được gì.** Bản ấy cho những dòng chưa có dấu kỳ "thừa hưởng" dấu
  của cả bản trạng thái — mà dấu ấy chính là kỳ đang mở, nên nó tự đóng dấu "đúng kỳ" cho mọi thứ
  nó gặp. Tự khẳng định điều cần chứng minh. Mở T09 vẫn thấy nguyên số T08.
* Với dữ liệu từ bản cũ thì **không có cách nào biết** mấy con số ấy của tháng nào — điều đó không
  nằm trong dữ liệu. Nên hỏi đúng **một lần cho mỗi kỳ**, bằng một dòng gọn trên cả ba màn
  (Tổng quan · Doanh thu · Lương):
  **[Để trống hết, lấy lại số tháng này]** hoặc **[Giữ lại — đây đúng là số tháng này]**.
* Trả lời xong là mọi dòng có dấu, từ đó máy tự dọn mãi mãi, không hỏi lại. Có Hoàn tác.

= 1.26.0 =
* 🔴 **Bỏ hẳn chuyện "kỳ cũ / kỳ này". Mở kỳ nào thì bảng chỉ có số của kỳ ấy; chỗ nào chưa có số
  thì ĐỂ TRỐNG.** (Anh Thắng: *"qua kỳ mới thì lấy số liệu tháng mới, dữ liệu nào không có thì để
  trống là được"*, *"10 người nhìn chứ không phải 1 người nhìn, không có thì bỏ trống, chứ đừng cũ
  mới, không ai hiểu được"*.)
* Gỡ toàn bộ nhãn **⚠ kỳ cũ** trên từng dòng, dòng "SỐ KỲ TRƯỚC" và nút "Đưa về 0" của bản 1.25.0.
  Một bảng đầy nhãn cảnh báo thì mười người đọc ra mười ý, mà con số sai vẫn nằm đó.
* Mở trang hoặc đổi kỳ là **tự dọn**: số không thuộc kỳ đang mở bị để trống, kèm một dòng nhắc
  ngắn. Không hỏi, không phải bấm nút nào.
* Ô số liệu từng kỳ (doanh thu điểm bán, 4 cột tiền của Mục III) **hiện ô trống thay vì số 0** —
  "chưa có" và "có mà bằng 0" là hai chuyện khác nhau.
* Bản cũ chưa có dấu kỳ trên từng dòng thì thừa hưởng dấu của cả kỳ, nên kỳ đang đúng không bị dọn
  oan khi nâng cấp.
