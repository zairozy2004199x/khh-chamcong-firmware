...
| `khunc-uy-nhiem-chi/` | **Plugin WordPress "Ủy Nhiệm Chi & Công Nợ (K&H)"** — bản chạy trên hosting WordPress: đăng nhập PIN, 3 vai trò (Admin · Kế toán · Xem), kế toán nhập Excel một lần rồi **cả bộ phận thấy cùng một bộ số**, đánh dấu ở máy này máy kia thấy ngay. Dữ liệu trong MySQL, nhật ký thao tác, tự cập nhật từ nhánh GitHub. Cài bằng zip từ Releases (`khunc-uy-nhiem-chi-vX.Y.Z`). Xem `khunc-uy-nhiem-chi/readme.txt` |
