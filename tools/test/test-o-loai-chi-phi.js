...
const nguon = BP_THAT + '\n' + ['_khoiCuaLoai', '_vaiDungDuocLoai', '_vaiTachLoai', '_mangCua', '_donNhieuCoSo', '_mangPham', '_tkNoList', '_tapTkCo', '_tkNoCua', '_khoaNhom', '_dauMucCua', '_dauMucDangDung', '_hopNhomCp', '_bpTach', '_loaiCpList', '_loaiCpVi'].map(layHam).join('\n')
