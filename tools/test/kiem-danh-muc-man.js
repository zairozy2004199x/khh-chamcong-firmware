...
t('báo số món đã đóng bị bỏ khi nạp; chú thích nói món Trạng thái 0 tự bị bỏ', /bỏ ' \+ v\.dong \+ ' món đã đóng/.test(vd) && /Món <b>đã đóng<\/b> trên FABi \(Trạng thái 0\) tự bị bỏ/.test(vd));
