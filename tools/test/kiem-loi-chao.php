...
$wpdb->insert( VHCC_DB::t( 'cham_cong' ), array( 'coso' => 'LC_CS', 'ngay' => gmdate( 'Y-m-d', strtotime( $hn . ' -6 days' ) ),
	'ma_nv' => 'LC1', 'hau_to' => '', 'ho_ten' => 'x', 'gio_vao_giay' => 28800, 'gio_ra_giay' => 57600, 'nguon' => 'may' ) );
$c = VHCC_Online::du_lieu_chao( 'LC1' );
...
t( '   hôm nay đã chấm vào -> 5 ngày', 5 === VHCC_Online::du_lieu_chao( 'LC1' )['chuoi'] );
t( '   mã rỗng -> không lỗi, chuỗi 0', 0 === VHCC_Online::du_lieu_chao( '' )['chuoi'] );
...
t( '   máy chủ gửi `chao` trong lượt `toi`', false !== strpos( file_get_contents( $goc . '/wordpress/vhcp-cham-cong/includes/class-vhcc-tram.php' ), "\$tt['chao'] = VHCC_Online::du_lieu_chao(" ) );
