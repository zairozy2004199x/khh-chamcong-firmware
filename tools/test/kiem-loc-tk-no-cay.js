...
{
  const O = { xuatSoDon: {}, xuatSoDong: {}, xuatEmpty: { style: {} }, xuatHead: {}, xuatBody: {}, xuatTable: { style: {} }, xuatTablesDauMuc: { style: {} } };
  ...
  /* 25/09/2026: renderXuat gọi thêm _veOMang (ô lọc Mảng kinh doanh) — tiêm stub cùng chỗ với _veOTkNo;
     cùng ngày tách bảng theo mảng → cần _xuatColsHead/_xuatRowHtml và hai thẻ xuatTable/xuatTablesDauMuc. */
  new Function('el', 'XUAT', 'BOOT', 'esc', 'money', 'renderXuatWarn', 'renderXuatBanGiao', '_veOTkNo', '_veOMang', ham('_laMaDon') + ham('_xuatKhoiDauMuc') + ham('_xuatColsHead') + ham('_xuatRowHtml') + ham('renderXuat') + '\nrenderXuat();')(
