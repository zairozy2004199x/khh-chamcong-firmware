...
teq( '🔴 dò trùng theo lô: đúng 1 câu khoa IN (…) cho cả đợt', 1, $db->so_select_lo );
...
$db->so_insert = 0; $db->so_get_row_khoa = 0; $db->so_select_lo = 0;
...
teq( 'vẫn chỉ 1 câu dò lô, 0 câu theo dòng', 1, $db->so_select_lo + $db->so_get_row_khoa );
...
t( '🔴 khoá lạ nhưng ref+tiền trùng → trùng, không chèn (cong_dong_trung vẫn chạy cho dòng "chưa có theo khoá")', 0 === $r3['themMoi'] && 1 === $r3['trungBoQua'] && 0 === $db->so_insert, $r3 );
