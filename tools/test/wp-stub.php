...
function vhcp_test_boot( $dir ) {
	...
	foreach ( array( 'util', 'db', 'meta', 'cfg', 'auth', 'log', 'don', 'sochi', 'duan', 'mk', 'bp', 'report', 'misa', 'upload', 'import' ) as $c ) {
