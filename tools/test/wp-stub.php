...
function vhcp_test_create_tables() {
	...
	$q = array(
		...
		"CREATE TABLE {$p}mk_don (stt INTEGER PRIMARY KEY AUTOINCREMENT, ma TEXT UNIQUE, coso TEXT DEFAULT '', ten TEXT DEFAULT '', ky TEXT DEFAULT '', kenh TEXT DEFAULT '', trang_thai TEXT DEFAULT 'Đang chạy', ngay_tao TEXT DEFAULT '', nguoi_tao TEXT DEFAULT '', mang TEXT DEFAULT 'kvc')",
		...
		"CREATE TABLE {$p}bp_index (stt INTEGER PRIMARY KEY AUTOINCREMENT, ma TEXT UNIQUE, loai TEXT DEFAULT '', ten TEXT DEFAULT '', nguoi TEXT DEFAULT '', dia_diem TEXT DEFAULT '', ky TEXT DEFAULT '', trang_thai TEXT DEFAULT 'Đang xử lý', ngay_tao TEXT DEFAULT '', nguoi_tao TEXT DEFAULT '', mang TEXT DEFAULT 'kvc')",
		...
		"CREATE TABLE {$p}log (id INTEGER PRIMARY KEY AUTOINCREMENT, tg TEXT, nguoi TEXT DEFAULT '', vai_tro TEXT DEFAULT '', hanh_dong TEXT DEFAULT '', doi_tuong TEXT DEFAULT '', chi_tiet TEXT DEFAULT '', mang TEXT DEFAULT 'kvc')",
		...
		"CREATE TABLE {$p}thungrac (id INTEGER PRIMARY KEY AUTOINCREMENT, luc TEXT, loai TEXT DEFAULT '', khoa TEXT DEFAULT '', nhan TEXT DEFAULT '', du_lieu TEXT, nguoi TEXT DEFAULT '', vai_tro TEXT DEFAULT '', don_vi TEXT DEFAULT '', da_hoan INTEGER DEFAULT 0, hoan_luc TEXT, hoan_nguoi TEXT DEFAULT '', mang TEXT DEFAULT 'kvc')",
		/* Lệnh tạm ứng — mỗi lượt quản lý bấm duyệt một tờ. */
		"CREATE TABLE {$p}lenh_tu (stt INTEGER PRIMARY KEY AUTOINCREMENT, id TEXT UNIQUE, luc TEXT, nguoi TEXT DEFAULT '', don_vi TEXT DEFAULT '', ky TEXT DEFAULT '', tong REAL DEFAULT 0, so_don INTEGER DEFAULT 0, so_coso INTEGER DEFAULT 0, chi_tiet TEXT, mang TEXT DEFAULT 'kvc')",
	);
