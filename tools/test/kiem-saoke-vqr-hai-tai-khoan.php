...
t( 'app: ô chọn tài khoản chỉ ở tab Việt QR, gửi làm tham số thứ 5, vẽ lại từ d.taiKhoan giữ lựa chọn', false !== strpos( $app, "nguon === 'vietqr'\n          ? '<div class=\"fld\"><label>🏦 Tài khoản VietQR</label>" ) && false !== strpos( $app, ".getSaoKeCong(PIN, nguon, tu, den, tk, CG_LOCCS[nguon] || '');" ) /* 0.55.0: tham số 6 = cơ sở */ && false !== strpos( $app, 'var oTk = cgEl(nguon,\'tk\'), dsTk = d.taiKhoan || [];' ) );
