...
t( '38 hàm RPC vẫn qua can_pin (0.51.0 taoCoSoGhe, 0.57.0 ganMayGhe, 0.59.0 tuGanNhanCoSo; không hàm nào tự so PIN riêng)', 38 === substr_count( $src, 'self::can_pin(' ) && 1 === substr_count( $src, "hash_equals( \$luu, (string) \$pin )" ) );
