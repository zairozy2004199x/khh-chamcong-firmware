...
class KHTC_SaoLuu {
	...
	public static function bang() {
		return array( 'ngan_hang', 'diem', 'giao_dich', 'doi_soat', 'ds_dong', 'chi_phi', 'hd_ra', 'hd_vao', 'hop_dong', 'ho_so', 'thanh_toan', 'nhat_ky' );
	}
	...
	public static function nhap( $json ) {
		...
		// self::bang().
		$thu_tu = array( 'ngan_hang', 'diem', 'doi_soat', 'giao_dich', 'ds_dong', 'chi_phi', 'hd_ra', 'hd_vao', 'hop_dong', 'ho_so', 'thanh_toan', 'nhat_ky' );
