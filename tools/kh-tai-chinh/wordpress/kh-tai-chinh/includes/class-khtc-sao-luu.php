...
class KHTC_SaoLuu {
	...
	public static function bang() {
		return array( 'ngan_hang', 'giao_dich', 'doi_soat', 'ds_dong', 'chi_phi', 'hd_ra', 'hd_vao', 'thanh_toan', 'nhat_ky' );
	}
	...
	public static function nhap( $json ) {
		...
		// self::bang().
		$thu_tu = array( 'ngan_hang', 'doi_soat', 'giao_dich', 'ds_dong', 'chi_phi', 'hd_ra', 'hd_vao', 'thanh_toan', 'nhat_ky' );
